...
export const HeroSection = () => {
    ...
    return (
        <section
            ref={containerRef}
            className="relative min-h-screen flex flex-col items-center justify-center px-6 pt-20 pb-20"
        >
            <motion.div
                style={{ opacity, scale }}
            ...
            >
                ...
                <div className="space-y-1">
                    ...
                    >
                        I design and build full-stack, scalable, intelligent systems centered on human experience.
                    </motion.p>
                </div>
