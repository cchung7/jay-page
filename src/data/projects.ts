export const projects = [
  { name: "County Level Air Quality Prediction (CLAP)", 
    ...
    links: { live: "https://clap-v1-2-render.onrender.com/", git: "https://github.com/cchung7/clap_v1.2-render" },
    tags: ["Python", "Flask", "HTML", "Tailwind CSS", "JavaScript", "React", "Vite", "Render"]
  },
